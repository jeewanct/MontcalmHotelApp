    ...
    func addViews(){
        ...
        if #available(iOS 11.0, *){
            contentTable.anchorWithConstantsToTop(top: view.safeAreaLayoutGuide
                .topAnchor, left: view.leftAnchor, bottom: bottomView.topAnchor, right: view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 16, rightConstant: 0)
        }else{
            contentTable.anchorWithConstantsToTop(top: topLayoutGuide.bottomAnchor, left: view.leftAnchor, bottom: bottomView.topAnchor, right: view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 16, rightConstant: 0)
        }
